...
Route::view('/druk-dla-firm', 'druk-dla-firm')->name('services.business');
...
Route::get('/zamowienie/{order}/sukces', [CheckoutController::class, 'success'])->name('checkout.success');

Route::prefix('admin')->name('admin.')->group(function (): void {
    Route::get('/logowanie', [AuthController::class, 'create'])->name('login');
    Route::post('/logowanie', [AuthController::class, 'store'])->name('login.store');
